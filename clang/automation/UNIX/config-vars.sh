...
if [ -z "$TEST_SUITE" ]; then
  echo "TEST_SUITE not set: must be set to one of CheckedC-tests, CheckedC, CheckedC_clang, or CheckedC_LLVM"
  CHECKEDC_CONFIG_STATUS="error" 
elif [ "$TEST_SUITE" != "CheckedC" -a "$TEST_SUITE" != "CheckedC_clang" -a \
       "$TEST_SUITE" != "CheckedC_LLVM" -a "$TEST_SUITE" != "CheckedC-tests"]; then
  echo "Unknown TEST_SUITE value $TEST_SUITE: must be one of CheckedC-tests, CheckedC, CheckedC_clang, or CheckedC_LLVM"
  CHECKEDC_CONFIG_STATUS="error" 
fi
